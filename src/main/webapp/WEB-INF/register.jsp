...
<body>
	<div class="flex">
		...
		<form:form class="newForm" action="/users" method="POST" modelAttribute="user" >
			...
			<p class="error"><form:errors path="first"></form:errors></p>
			<p><form:input placeholder="First Name" path="first"></form:input></p>
			
			<p class="error"><form:errors path="last"></form:errors></p>
			<p><form:input placeholder="Last Name" path="last"></form:input></p>
